...
public class PracticeReminderService extends IntentService {
    ...
    private static final String EXERCISES_SELECTION = Exercises.COLUMN_DISABLED + " = 0 AND " + Exercises.COLUMN_PRACTICE_COUNT + " > 0 AND " + Exercises.COLUMN_PRACTICE_TIME + " < CAST(? AS INTEGER)";
